...
ALLOWED_RELATIONS = {
    ...
    "tests_phrase": "question → phrase (人工核验 phrase_id↔空; 非共现)",
    "has_descriptor": "quality_level → quality_descriptor (课标学业质量描述)",
    "aligned_to_quality_level": "exam_scope → quality_level (卷级对齐, 非逐题)",
